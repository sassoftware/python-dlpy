...
def ResNet152_Model(s, model_name='RESNET152', n_channels=3, width=224, height=224,
    ...
    '''
    # TODO: Use fully-qualified CAS action names
    ...
    s.deepLearn.addLayer(model=model_name, name='bn_conv1',
    ...
    s.deepLearn.addLayer(model=model_name, name='res2a_branch1',
    ...
    s.deepLearn.addLayer(model=model_name, name='res3a_branch1',
