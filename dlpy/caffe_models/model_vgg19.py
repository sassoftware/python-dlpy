...
def VGG19_Model(s, model_name='VGG19', n_channels=3, width=224, height=224,
    ...
    s.deepLearn.addLayer(model=model_name, name='conv3_4',
                         layer=dict(type='convolution', nFilters=256, width=3, height=3,
                                    stride=1, act='relu'),
                         srcLayers=['conv3_3'])
    ...
    s.deepLearn.addLayer(model=model_name, name='conv4_4',
                         layer=dict(type='convolution', nFilters=512, width=3, height=3,
                                    stride=1, act='relu'),
                         srcLayers=['conv4_3'])
    ...
    s.deepLearn.addLayer(model=model_name, name='conv5_4',
                         layer=dict(type='convolution', nFilters=512, width=3, height=3,
                                    stride=1, act='relu'),
                         srcLayers=['conv5_3'])
