...
if __name__ == '__main__':
    ...
    if 'CAFFE_HDF5_PATH' not in os.environ:
        err_msg = ('Environment variable CAFFE_HDF5_PATH not set.  '
                   'Please set this variable to \npoint to the directory where '
                   'HDF5 files are or will be stored \n')
        sys.exit(err_msg)

    if 'CAFFE_PYTHON_PATH' in os.environ:
    ...
    if 'CAFFE_APPLICATION_PATH' in os.environ:
        sys.path.append(os.environ['CAFFE_APPLICATION_PATH'])
    else:
        err_msg = ('Environment variable CAFFE_APPLICATION_PATH not set.  '
    ...
    if model_name == 'ResNet50':
        # ResNet-50
        network_file = os.path.join(os.environ['CAFFE_APPLICATION_PATH'],
                                    'ResNet-50-deploy.prototxt')
        network_param = os.path.join(os.environ['CAFFE_HDF5_PATH'],
    ...
    sas_python = os.path.join(os.environ['CAFFE_APPLICATION_PATH'],
                              'sas_model.py')
