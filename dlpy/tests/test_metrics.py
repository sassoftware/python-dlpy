...
class TestMetrics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s = swat.CAS()
        self.server_sep = get_server_path_sep(self.s)
        ...
        self.class_table1 = self.s.upload_frame(self.local_class1,
                                                   casout=dict(name=random_name(name='class1_'), replace=True))
        self.class_table2 = self.s.upload_frame(self.local_class2,
                                                   casout=dict(name=random_name(name='class2_'), replace=True))
        self.class_table3 = self.s.upload_frame(self.local_class3,
                                                   casout=dict(name=random_name(name='class3_'), replace=True))
        self.class_table4 = self.s.upload_frame(self.local_class4,
                                                   casout=dict(name=random_name(name='class4_'), replace=True))
        self.reg_table1 = self.s.upload_frame(self.local_reg1,
                                                 casout=dict(name=random_name(name='reg1_'), replace=True))
        self.reg_table2 = self.s.upload_frame(self.local_reg2,
